...
//bubble sort to sort in ascending order on roll number void bubble_sort(stud s[20],int n)
void bubble_sort(stud s[20], int n)
{
    int i, j;
    stud temp;
...
// insertion sort to sort on names in ascending order void insertionSort(stud s[20], int n)
void insertionSort(stud s[20], int n)
{
    int i, j;
    stud key;
